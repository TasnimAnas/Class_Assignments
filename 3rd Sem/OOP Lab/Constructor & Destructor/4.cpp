...
Problem:
WAP using appropriate constructors and destructors to represent the vector
...
public:
    ...
    Vector_762(int coordinates_762)
    {
        this->coordinates_762 = coordinates_762;
    }
